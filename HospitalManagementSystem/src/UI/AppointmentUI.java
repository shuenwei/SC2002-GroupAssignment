...
public class AppointmentUI {
    ...
    public void displayAppointments(IListDisplayableView<Appointment> appointmentListView, ArrayList<Appointment> pendingAppointments, ArrayList<Appointment> confirmedAppointments,ArrayList<Appointment> medicinePendingAppointments,ArrayList<Appointment> completedAppointments, ArrayList<Appointment> cancelledAppointments){
        ...
        int totalNoOfAppointments = noOfPendingAppointments + noOfConfirmedAppointments + noOfMedicinePendingAppointments + noOfCompletedAppointments + noOfCancelledAppointments;
